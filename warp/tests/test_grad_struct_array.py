...
add_function_test(TestGradStructArray, "test_struct_array_gradient_propagation_scalar", test_struct_array_gradient_propagation_scalar, devices=devices)
add_function_test(TestGradStructArray, "test_struct_array_gradient_propagation_vec3", test_struct_array_gradient_propagation_vec3, devices=devices)
add_function_test(TestGradStructArray, "test_struct_array_gradient_propagation_mat22", test_struct_array_gradient_propagation_mat22, devices=devices)
